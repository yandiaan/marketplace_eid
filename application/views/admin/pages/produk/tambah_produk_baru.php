                            ...
                            <div id="galeri-produk" class="row">
                                    ...
                                    <div id="box-foto-utama" class="img-box mb-2" style="display:none;">
                                        ...
                                        <div class="img-action">
                                            <div class="d-flex justify-content-center py-1">
                                                <button type="button" class="delete-image" data-key="foto-utama"><i class="fas fa-fw fa-trash-alt"></i> Hapus</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    ...
                                    <div id="box-foto-1" class="img-box mb-2" style="display:none;">
                                        ...
                                        <div class="img-action">
                                            <div class="d-flex justify-content-center py-1">
                                                <button type="button" class="delete-image" data-key="foto-1"><i class="fas fa-fw fa-trash-alt"></i> Hapus</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-2">
                                    ...
                                    <div id="box-foto-2" class="img-box mb-2" style="display:none;">
                                        ...
                                        <div class="img-action">
                                            <div class="d-flex justify-content-center py-1">
                                                <button type="button" class="delete-image" data-key="foto-2"><i class="fas fa-fw fa-trash-alt"></i> Hapus</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
