...
<div class="row mt-5">
    <div class="col-md-8">
        ...
        <nav class="nav mb-3">
            <a class="nav-link btn btn-outline-eid rounded-pill me-3 fw-bold" href="#">Pilih Alamat Pengiriman</a>
            <a class="nav-link btn btn-primary-eid rounded-pill fw-bold" aria-current="page" href="#">Masukkan Alamat Baru</a>
        </nav>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label fw-bold">Nama Penerima</label>
            <input type="text" class="form-control rounded-1" id="exampleFormControlInput1" placeholder="Masukkan Nama Lengkap">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label fw-bold">Nomor Telepon</label>
            <input type="text" class="form-control rounded-1" id="exampleFormControlInput1" placeholder="Masukkan Nomor Telepon">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label fw-bold">Alamat</label>
            <input type="text" class="form-control rounded-1" id="exampleFormControlInput1" placeholder="Masukkan Alamat">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label fw-bold">Kode Pos</label>
            <input type="text" class="form-control rounded-1" id="exampleFormControlInput1" placeholder="Masukkan Kode Pos">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label fw-bold">Pesan</label>
            <input type="text" class="form-control rounded-1" id="exampleFormControlInput1" placeholder="buat pesan untuk penjual (opsional)">
        </div>
    </div>
            ...
            <div class="card-body">
                ...
                <div class="card-text">
                    <div class="d-flex justify-content-between mb-2">
                        <div class="text-secondary">Harga (3 produk)</div>
                        <div class="text-secondary">Rp35.395.500 </div>
                    </div>
                    <form action="" class="mb-2">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Masukkan kode promo" aria-label="Username" aria-describedby="basic-addon1">
                            <button class="input-group-text" id="basic-addon1">Gunakan</button>
                        </div>
                    </form>
                    <div class="d-flex justify-content-between mb-2">
                        <div class="text-secondary">Total diskon</div>
                        <div class="text-secondary">-Rp10.800.000</div>
                    </div>
                    <div class="d-flex justify-content-between mb-2">
                        <div class="text-secondary">PPN (11%) </div>
                        <div class="text-secondary"> Rp10.800.000</div>
                    </div>
                </div>
            </div>
            <div class="card-footer bg-transparent border-success">
                <div class="d-flex justify-content-between mb-2 fs-4 fw-bold font-color">
                    <p>Total Harga :</p>
                    <p>Rp46.195.500 </p>
                </div>
