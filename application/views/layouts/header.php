<nav class="navbar navbar-expand-lg sticky-top bg-white px-5 py-3 shadow-sm">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <form class="container-fluid mx-3 mb-2 mb-lg-0" action="<?= base_url("pencarian"); ?>" method="GET"
                role="search">
                <div class="input-group search-bar">
                    ...
                    <button class="btn btn-search" style="z-index: -9999;" type="submit"><i
            ...
            <a role="button" class="btn-cart me-4" id="cart">
                <div class="contain-cart">
                    <span class="count px-1">0</span>
                    <div class="data-cart placeholder-glow visually-hidden shadow-lg">
                        <span class="py-3 placeholder mt-3 rounded" style="width: 10%;"></span>
                        <span class="placeholder mt-3 rounded ms-3" style="width: 85%;">Placeholders</span>
                        <span class="py-3 placeholder mt-3 rounded" style="width: 10%;"></span>
                        <span class="placeholder mt-3 rounded ms-3" style="width: 85%;">Placeholders</span>
                        <span class="py-3 placeholder mt-3 rounded" style="width: 10%;"></span>
                        <span class="placeholder mt-3 rounded ms-3" style="width: 85%;">Placeholders</span>
