                ...
                <div class="card shadow-lg p-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="" class="mt-4">
                            <div class="mb-3">
                                <input type="email" class="form-control" style="border-radius: 2px; font-size: 13px;" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Email">
                            </div>
                            <div class="mb-5">
                                <input type="email" class="form-control" style="border-radius: 2px; font-size: 13px;" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Password">
                            </div>
                            <div class="mb-3 d-grid gap-2">
                                <button type="submit" class="btn btn-sm btn-primary-eid fw-semibold" style="border-radius: 2px;">LOG IN</button>
