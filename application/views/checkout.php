<div class="container">
    <div class="d-grid gap-2">
        <button class="btn btn-primary text-white" type="button"><svg width="48" height="48" viewBox="0 0 48 48"
    ...
    <div class="row mt-5">
        <div class="col-md-8">
            ...
            <nav class="nav mb-3">
                <a class="btn btn-primary text-white rounded-pill me-3 fw-bold" aria-current="page" href="#">Pilih
                    Alamat Pengiriman</a>
            ...
            <div class="card border-secondary mb-3">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <p class="fw-bold">Kantor Utama <small class="bg-primary text-white p-1">Alamat
                                    Utama</small></p>
