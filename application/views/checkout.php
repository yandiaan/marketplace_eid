...
<div class="row mt-5">
    <div class="col-md-8">
        ...
        <p class="fw-bold mb-2">Pesan</p>
        <div class="mb-3">
            <input type="text" class="form-control form-control-lg" id="exampleFormControlInput1" placeholder="buat pesan untuk penjual (opsional)">
        </div>
    </div>
    <div class="col-md-4">
