<div class="container">
    <section class="head-content-cart d-flex align-items-center text-white fs-4 bg-primary-eid w-100 px-3 py-4">
        <i class="fa fa-cart-shopping"></i>
        <h4 class="fw-bolder ms-2 my-auto mx-4 title-cart">Keranjang Belanja</h4>
        <div class="input-group search-cart">
            <input type="text" class="form-control" placeholder="Cari di keranjang belanja" aria-label="search" aria-describedby="button-addon2">
            <button class="btn btn-secondary px-4" type="button" id="button-addon2"> <i class="fa fa-search"></i>
            </button>
        </div>
    </section>
    <section class="mt-4">
...
<script src="<?= base_url("assets/src/js/pages/cartPage.js"); ?>"></script>