                                ...
                                <div class="rate col-8">
                                    <div class="rate-item d-flex align-items-center">
                                        ...
                                        <div class="progress w-75 mx-2">
                                            <div class="progress-bar bg-success w-50" role="progressbar" aria-label="Basic example" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    ...
                                    <div class="rate-item d-flex align-items-center">
                                        ...
                                        <div class="progress w-75 mx-2">
                                            <div class="progress-bar bg-success w-0" role="progressbar" aria-label="Basic example" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                        ...
                        <div class="col-7">
                            <div class="review-form text-white bg-success p-4">
                                <div class="input-form">
                                    ...
                                    <textarea class="form-control bg-transparent text-white input-review" name="review" id="" cols="30" rows="5" placeholder="Bagikan pengalaman Anda di sini"></textarea>
